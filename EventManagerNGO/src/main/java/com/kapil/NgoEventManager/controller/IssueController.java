...
import com.kapil.NgoEventManager.modal.IssueDTO;
...
import com.kapil.NgoEventManager.service.IssueService;
...
//        User user = userService.findUserById(token.getId());
        ...
        issueDTO.setDescription(createdIssue.getDesciption());
    ...
    public ResponseEntity<MessageResponse> deleteIssue
            (@PathVariable Long issueId, @RequestHeader("Authorization") String token)
            throws Exception {
