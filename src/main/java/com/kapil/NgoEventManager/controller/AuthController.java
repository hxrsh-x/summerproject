...
import com.kapil.NgoEventManager.request.LoginRequest;
import com.kapil.NgoEventManager.response.AuthResponse;
import com.kapil.NgoEventManager.service.CustomUserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws Exception{
        ...
        subcriptionService.createSubcription(createdUser);
