        ...
        <div className="flex justify-between border p-10 rounded-lg">
            ...
            <ScrollArea  className="h-[80vh] w-[60%]">
                ...
                <div className="py-5">
                    ...
                    <p className="text-gray-400 text-sm mt-3"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero non necessitatibus nobis eaque possimus dignissimos!</p>
                ...
                <div className="p-5">
                    <div className="space-y-7">
                         <div className="flex gap-10 items-center ">
                            <p className="w-[7rem]"> Asigned To  </p>
